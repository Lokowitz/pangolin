...
export default async function migration() {
    ...
    try {
        ...
        await db.execute(`DROP TABLE 'resources';`);
        await db.execute(
        ...
        await db.execute(`ALTER TABLE 'domains' ADD 'certResolver' text;`);
        await db.execute(
        ...
        await db.execute(`ALTER TABLE 'orgs' DROP COLUMN 'settings';`);
        await db.execute(
            `ALTER TABLE 'resourceSessions' ADD 'issuedAt' integer;`
        );
        await db.execute(`ALTER TABLE 'session' ADD 'issuedAt' integer;`);
        await db.execute(
